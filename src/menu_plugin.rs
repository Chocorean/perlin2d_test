...
use crate::{despawn_screen, GameState, Volume};
    ...
    commands
        ...
        .with_children(|parent| {
            ...
            parent
                ...
                .with_children(|parent| {
                    let icon = asset_server.load("textures/menu/right.png");
            ...
            parent
                ...
                .with_children(|parent| {
                    let icon = asset_server.load("textures/menu/wrench.png");
                    parent.spawn_bundle(ImageBundle {
                        style: button_icon_style.clone(),
                        image: UiImage(icon),
                        ..default()
            ...
            parent
                ...
                .with_children(|parent| {
                    let icon = asset_server.load("textures/menu/exitRight.png");
                    parent.spawn_bundle(ImageBundle {
